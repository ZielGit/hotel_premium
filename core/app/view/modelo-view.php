    ...
    <div class="box box box-danger">
      ...
      <div class="tile-body" style="left: 20px; font-size: 29px;color: black;">
        ...
        ?>
          ...
          <h4>
            <td>CLIENTE:</td> <?php echo $operacion->getCliente()->nombre; ?>
          </h4>
          ...
          <table class="table table-bordered table-hover">
            ...
            <tr>
              <th colspan="3" style="border-right: 1px solid #a09e9e;">
                <p style="float: right;font-size: 18px;">Total $ </p>
              </th>
