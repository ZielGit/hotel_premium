					...
					<div class="form-group">
						<div class="row">
							<div class="col-sm-6">
								...
								<select data-placeholder="..." name="contado" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
							...
							<div class="col-sm-6">
								...
								<div class="form-group has-feedback has-feedback-left">
									<input type="text" name="nro_comprobante" placeholder="04508" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
