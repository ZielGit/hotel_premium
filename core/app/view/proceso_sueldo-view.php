              ...
              <table id="searchTextResults" data-filter="#filter" data-page-size="7" class="footable table table-custom" style="font-size: 11px;">
                ...
                <?php foreach ($procesos as $proceso) : ?>
                  <tr>
                    ...
                    <td>
                      <?php if ($proceso->tipo == '1') {
                        echo "PAGO";
                      } else if ($proceso->tipo == '2') {
                        echo "AUMENTO";
                      } else if ($proceso->tipo == '3') {
                        echo "DESCUENTO";
                      } ?>
                    </td>
                    <td>
                  ...
                  <?php if ($proceso->tipo == '1' and $proceso->estado == '1') {
                    $pago = $proceso->monto + $pago;
                  } else if ($proceso->tipo == '2' and $proceso->estado == '1') {
                    $aumento = $proceso->monto + $aumento;
                  } else if ($proceso->tipo == '3' and $proceso->estado == '1') {
                    $descuento = $proceso->monto + $descuento;
                  } ?>
                <?php endforeach; ?>
              </table>
            <?php } else {
