                          ...
                          <div class="col-md-offset-1 col-md-10">
                            ...
                            <div class="form-group">
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control col-md-8" name="nombre" placeholder="Nombre empresa" value="<?php if ($nombre != 'NULL') {
                                                                                                                                      echo $nombre;
                                                                                                                                    } ?>">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="direccion" placeholder="Dirección" value="<?php if ($direccion != 'NULL') {
                                                                                                                          echo $direccion;
                                                                                                                        } ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="estado" placeholder="Estado o provincia" value="<?php if ($estado != 'NULL') {
                                                                                                                                echo $estado;
                                                                                                                              } ?>">
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="telefono" placeholder="Teléfono" value="<?php if ($telefono != 'NULL') {
                                                                                                                        echo $telefono;
                                                                                                                      } ?>">
                              </div>
                            </div>
                          ...
                          <div class="col-md-offset-1 col-md-10">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control col-md-12" name="rnc" value="<?php if ($rnc != 'NULL') {
                                                                                                      echo $rnc;
                                                                                                    } ?>">
                              </div>
                            </div>
                          ...
                          <div class="col-md-offset-1 col-md-10">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control col-md-12" name="ciudad" value="<?php if ($ciudad != 'NULL') {
                                                                                                          echo $ciudad;
                                                                                                        } ?>">
                              </div>
                            </div>
