            ...
            <table id="searchTextResults" data-filter="#filter" data-page-size="7" class="footable table table-custom" style="font-size: 11px;">
              ...
              <?php foreach ($productos as $producto) : ?>
                <tr>
                  ...
                  <td><?php if ($producto->descripcion != "NULL") {
                  ...
                  <td><?php if ($producto->id_proveedor != "NULL" and $producto->id_proveedor != 0) {
                        echo $producto->getProveedor()->nombre;
                      } else {
                        echo "------";
                      } ?></td>
                  <td>
                              ...
                              <div class="col-md-offset-1 col-md-10">
                                ...
                                <div class="form-group">
                                  <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="marca" value="<?php if ($producto->marca != 'NULL') {
                                                                                                  echo $producto->marca;
                                                                                                } else {
                                                                                                  echo "";
                                ...
                                <div class="form-group">
                                  <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="presentacion" value="<?php if ($producto->presentacion != 'NULL') {
                                ...
                                <div class="form-group">
                                  <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="descripcion" value="<?php if ($producto->descripcion != 'NULL') {
                                                                                                        echo $producto->descripcion;
                                                                                                      } else {
                                                                                                        echo "";
                                                                                                      } ?>" placeholder="Ingrese detalles (OPCIONAL)">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <div class="input-group">
                                    <span class="input-group-addon"> Precio Compra</span>
                                    <input type="number" class="form-control" name="precio_compra" step="any" value="<?php if ($producto->precio_compra != 'NULL') {
                                                                                                                        echo $producto->precio_compra;
                                                                                                                      } else {
                                                                                                                        echo "";
                                                                                                                      } ?>" placeholder="Ingrese Precio (OPCIONAL)">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <div class="input-group">
                                ...
                                <div class="form-group">
                                  <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" name="stock" disabled required value="<?php if ($producto->stock != 'NULL') {
                                                                                                                      echo $producto->stock;
                                                                                                                    } else {
                                                                                                                      echo "";
