            ...
            <div class="row">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="date" name="start" class="form-control" value="<?php if (isset($_GET['start'])) {
                                                                                echo $_GET['start'];
                                                                              } ?>">
                </div>
              </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              <div class="input-group">
                ...
                <input type="date" name="end" class="form-control" value="<?php if (isset($_GET['end'])) {
                                                                            echo $_GET['end'];
                                                                          } ?>">
              </div>
            </div>
            ...
            <table id="searchTextResults" data-filter="#filter" data-page-size="7" class="footable table table-custom" style="font-size: 11px;">
              ...
              <?php foreach ($compras as $compra) : ?>
                <tr>
                  ...
                  <td><?php if ($compra->id_proveedor != NULL) {
                        echo $compra->getProveedor()->razon_social;
                      } else {
                        echo "--------";
                      } ?></td>
                  <td><?php echo number_format($compra->total, 2, '.', ','); ?></td>
                  <td><?php if ($compra->id_usuario != NULL) {
                        echo $compra->getUsuario()->name;
                      } else {
                        echo "--------";
                      } ?></td>
                  <td>
                                  ...
                                  <table id="tbldetalle" class="table table-xxs">
                                    ...
                                    <tbody>
                                      ...
                                      <?php foreach ($detalles as $detalle) : ?>
                                        <tr>
                                          <td></td>
                                          <td><?php if ($detalle->id_producto != null) {
                                                echo $detalle->getProducto()->nombre;
                                              } else {
                                                echo "<center>----</center>";
                                              }  ?></td>
