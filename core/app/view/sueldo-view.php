                ...
                <?php foreach ($sueldos as $sueldo) : ?>
                  <tr>
                    ...
                    if (count($acumulados) > 0) { ?>
                      <?php foreach ($acumulados as $acumula) : $acumulado = $acumula->monto + $acumulado;
                      endforeach; ?>
                    <?php } else {
                      $acumulado = 0;
                    }; ?>
                    ...
                    if (count($aumentos) > 0) { ?>
                      <?php foreach ($aumentos as $aume) : $aumento = $aume->monto + $aumento;
                      endforeach; ?>
                    <?php } else {
                      $aumento = 0;
                    }; ?>
                    ...
                    if (count($descuentos) > 0) { ?>
                      <?php foreach ($descuentos as $descuent) : $descuento = $descuent->monto + $descuento;
                      endforeach; ?>
                    <?php } else {
                      $descuento = 0;
                    }; ?>
