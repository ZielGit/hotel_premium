      ...
      <div class="box-body" style="text-align: left;">
        <table>
          ...
          <tr>
            ...
            <td>
              <h5 class="control-label text-red"><?php echo $_POST['start']; ?></h5>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <h5 class="control-label text-red"><?php echo $_POST['end']; ?></h5>
            </td>
          </tr>
        </table>
      </div>
                ...
                <?php foreach ($reporproducts as $reporproduct) : ?>
                  ...
                  <?php if ($reporproduct->fecha_creada != NULL) { ?>
                    <tr>
                      ...
                      <td><?php if ($reporproduct->id_operacion != NULL) {
                            echo $reporproduct->getProceso()->getHabitacion()->nombre;
                          } else {
                            echo "Venta libre";
                          } ?></td>
