      ...
      <div class="row">
        <div class="breadcrumb col-lg-12">
          <div style="background-color: #16a085;color: white;padding: 2px;font-size: 20px;
            ...
            <span>resumen de saldos y movimientos de productos</span>
          </div>
        </div>
      </div>
    </div>
                ...
                <input type="text" id="txtMes" name="txtMes" placeholder=""
                 class="form-control input-sm" style=""> -->
                  ...
                  <select class="form-control" name="anio">
                    <option value="2017" <?php if ($anio == '2017') {
                                            echo "selected";
                                          }; ?>>2017</option>
                    <option value="2018" <?php if ($anio == '2018') {
                                            echo "selected";
                                          }; ?>>2018</option>
                    <option value="2019" <?php if ($anio == '2019') {
                                            echo "selected";
                                          }; ?>>2019</option>
                    <option value="2020" <?php if ($anio == '2020') {
                                            echo "selected";
                                          }; ?>>2020</option>
                    <option value="2021" <?php if ($anio == '2021') {
                                            echo "selected";
                                          }; ?>>2021</option>
                    <option value="2022" <?php if ($anio == '2022') {
                                            echo "selected";
                                          }; ?>>2022</option>
                  </select>
                </div>
                ...
                <input type="text" id="txtMes" name="txtMes" placeholder=""
                 class="form-control input-sm" style=""> -->
                  <select class="form-control" name="mes">
                    <option value="00" <?php if ($me == '00') {
                                          echo "selected";
                                        }; ?>>--- Todos ---</option>
                    <option value="01" <?php if ($me == '01') {
                                          echo "selected";
                                        }; ?>>Enero</option>
                    <option value="02" <?php if ($me == '02') {
                                          echo "selected";
                                        }; ?>>Febrero</option>
                    <option value="03" <?php if ($me == '03') {
                                          echo "selected";
                                        }; ?>>Marzo</option>
                    <option value="04" <?php if ($me == '04') {
                                          echo "selected";
                                        }; ?>>Abril</option>
                    <option value="05" <?php if ($me == '05') {
                                          echo "selected";
                                        }; ?>>Mayo</option>
                    <option value="06" <?php if ($me == '06') {
                                          echo "selected";
                                        }; ?>>Junio</option>
                    <option value="07" <?php if ($me == '07') {
                                          echo "selected";
                                        }; ?>>Julio</option>
                    <option value="08" <?php if ($me == '08') {
                                          echo "selected";
                                        }; ?>>Agosto</option>
                    <option value="09" <?php if ($me == '09') {
                                          echo "selected";
                                        }; ?>>Setiembre</option>
                    <option value="10" <?php if ($me == '10') {
                                          echo "selected";
                                        }; ?>>Octubre</option>
                    <option value="11" <?php if ($me == '11') {
                                          echo "selected";
                                        }; ?>>Noviembre</option>
                    <option value="12" <?php if ($me == '12') {
                                          echo "selected";
                                        }; ?>>Diciembre</option>
                  </select>
                </div>
            ...
            <ul class="controls">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu pull-right with-arrow animated littleFadeInUp">
                  <li><a id="print_saldos" href="reporte/pdf/documentos/reporte_kardex_todo.php?anio=<?php echo $anio; ?>&mes=<?php echo $me; ?>" target="_blanck"><i class="icon-file-pdf"></i> Saldos y Movimientos</a></li>
                  <li class="divider"></li>
