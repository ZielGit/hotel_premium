<?php if (isset($_POST['id']) and $_POST['id'] == "1") { ?>
  ...
  <div class="form-group">
    ...
    <div class="input-group">
      ...
      <input type="text" class="form-control" name="documento" id="documento" required="required" placeholder="Ingrese documento para buscar" pattern="[z0-9]{8}" title="Solo puede ingresar 8 números">
...
<?php }
if (isset($_POST['id']) and $_POST['id'] == "2") { ?>
  <div class="form-group">
